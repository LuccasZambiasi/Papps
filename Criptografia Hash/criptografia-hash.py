...
def main(text, hashType):
    ...
    if hashType.lower() == 'md5':
        ...
        print('Tente um hash do tipo: md5 / sha1 / sha224 / sha256 / sha384 / sha512')
        exit(0)
    print("Codificado: ", myHash)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Converte texto para hash')
